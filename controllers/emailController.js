        ...
        const htmlTemplate = `
            ...
            <head>
                ...
                <style>
                    ...
                    ul li { color: #333333; font-weight: bold; }
                </style>
            </head>
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>Thank you for flying with us! We wish you a pleasant journey.</p>
                    </div>
...
//     try {
//         const transporter = createTransporter();
//         const { to, customers, pnr, seatNumber, checkInDate, passengerName, flightNumber, departure, destination, departureTime, arrivalTime, gateNumber } = req.body;
...
//                         </ul>
//                         <p><strong>PNR:</strong> ${pnr}</p>
//                         <p><strong>Date:</strong> ${departureTime}</p>
//                         <p>Thank you for flying with us! We wish you a pleasant journey.</p>
//                     </div>
...
//             from: process.env.EMAIL_USER,
//             to,
//             subject: 'Your Web Check-in Confirmation',
//             html: htmlTemplate,
//         };

//         await transporter.sendMail(mailOptions);
//         res.status(200).json({ message: 'Web check-in confirmation email sent successfully.' });
//     } catch (error) {
//         console.error('Error sending web check-in confirmation email:', error);
//         res.status(500).json({ message: 'Failed to send web check-in confirmation email.', error });
//     }
// };
